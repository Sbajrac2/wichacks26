  ...
  return (
    <main className="min-h-screen bg-slate-950 text-slate-50">
      <div className="mx-auto max-w-6xl px-6 py-14">
        ...
        <footer className="mt-15 text-xs text-slate-500">
          Don't let the right words escape you. This app helps you prepare, speak up, and support those who need it.
        </footer>
        <footer className="mt-10 text-xs text-slate-500">
          Disclaimer:
          This project was developed during a hackathon as a prototype intended for demonstration and educational purposes only. It may contain bugs, incomplete features, or inaccuracies and should not be relied upon for production use. This application does not provide professional, legal, medical, psychological, or workplace advice. Responses generated by AI may be inaccurate, incomplete, or biased, and users should exercise independent judgment when interpreting outputs. The creators assume no responsibility or liability for any actions taken based on the use of this application.
        </footer>
      </div>
    </main>
  );
